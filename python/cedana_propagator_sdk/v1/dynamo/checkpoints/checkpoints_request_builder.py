...
if TYPE_CHECKING:
    from ....models.dynamo_checkpoint_entry import DynamoCheckpointEntry
    from ....models.http_error import HttpError

class CheckpointsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/dynamo/checkpoints
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/dynamo/checkpoints?cluster_id={cluster_id}{&name*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CheckpointsRequestBuilderGetQueryParameters]] = None) -> Optional[list[DynamoCheckpointEntry]]:
        ...
        return await self.request_adapter.send_collection_async(request_info, DynamoCheckpointEntry, error_mapping)
