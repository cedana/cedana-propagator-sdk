...
if TYPE_CHECKING:
    ...
    from .....models.operations_summary import OperationsSummary

class SummaryRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/metrics/operations/summary
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[SummaryRequestBuilderGetQueryParameters]] = None) -> Optional[OperationsSummary]:
        ...
        Returns: Optional[OperationsSummary]
        """
        ...
        return await self.request_adapter.send_async(request_info, OperationsSummary, error_mapping)
