...
class NodesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/nodes
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[NodesRequestBuilderGetQueryParameters]] = None) -> Optional[list[NodeResponse]]:
        ...
        Returns: Optional[list[NodeResponse]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, NodeResponse, error_mapping)
